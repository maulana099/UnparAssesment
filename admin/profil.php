            ...
            <div class="col-lg-8">
              ...
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  ...
                  <img style="border-radius:50%;" src="img_adm/<?php echo $photo;?>" width='100' height='100'>
                  </h6>
                ...
                <div class="card-body">
                  <form>
                    <div class="form-group">
                      ...
                      <input type="text" name="nokta" class="form-control" value="<?php echo $nim; ?>" disabled id="exampleInputEmail1" aria-describedby="emailHelp">
                    ...
                    <label for="exampleInputEmail1">Photo</label>
                      <div class="custom-file">   
                        <input type="file" id="customFile" disabled>
                  </form>
                </div>
              </div>
            </div>

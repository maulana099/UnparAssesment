...
<div class="container-fluid" id="container-wrapper">
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active" aria-current="page">Isi Data Penghargaan</li>
    </ol>
  </div>
  <p><b>Tanda Penghargaan yang Diterima .</b> </p>
  ...
  <form action="tambahdatapenghargaan.php" method="post" enctype="multipart/form-data">
    <div class="row">
      <div class="col-lg-6">
        <!-- Form Basic -->
        <div class="card mb-4">
          <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
            <h6 class="m-0 font-weight-bold text-primary">Isi Data Penghargaan</h6>
          </div>
          <div class="card-body">
            ...
            <div class="form-group" id="simple-date1">
              ...
              <input type="text" class="form-control" name="nama_penghargaan" required="" placeholder="tidak ada">
              <br>
            </div>
          </div>
        </div>

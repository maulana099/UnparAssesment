...
$sql = "select * from datapenghargaan where id='$id'";
...
<div class="container-fluid" id="container-wrapper">
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Isi Data Penghargaan</h1>
    <ol class="breadcrumb">
      <li class="breadcrumb-item"><a href="./">Home</a></li>
      <li class="breadcrumb-item">Formulir Asesment Mandiri</li>
      <li class="breadcrumb-item active" aria-current="page">Edit Data Penghargaan</li>
    </ol>
  </div>
    ...
    <div class="col-lg-6">
      ...
      <div class="card mb-4">
        ...
        <div class="card-body">
            ...
            <br>
              <div class="input-group-prepend">
                      <span class="input-group-text">Nama Penghargaan</span>
                    </div>
                        <input type="text" class="form-control" value="<?php echo $nama_penghargaan; ?>" name="nama_penghargaan">
                    <br>
                   </div>
                 </div>
               </div>
              ...
              <div class="card mb-4">
                <div class="card-body">
                    ...
                    <div class="form-group">
                    <div class="input-group-prepend">
                      <span class="input-group-text">Uraian Singkat Penghargaan</span>
                    </div>
                    ...
                    <div class="form-group">  
                    <input type="submit" class="btn btn-primary" name="EDIT" id="EDIT" value="Simpan Data">
                    </div>
                </div>
              </div>
...
if(isset($_POST['ubah_foto'])){
      ...
      if(move_uploaded_file($tmp, $path)){ 
          ...
          $query = "UPDATE datapenghargaan SET nokta='$nokta', nama_lengkap='$nama', tahun='$tahun', nama_penghargaan='$nama_penghargaan', uraian='$uraian', kompetensi='$kompetensi', bukti_berkas='$bukti_berkas' where id='$id'";
          $sql = mysqli_query($connect, $query); 

           if($sql){
              echo "<script>alert('Data Berhasil Diedit');document.location='index.php?page=datapenghargaan'</script>"; // Redirect ke halaman index.php // Redirect ke halaman index.php
            }else{
          ...
          $query = "UPDATE datapenghargaan SET nokta='$nokta', nama_lengkap='$nama', tahun='$tahun', nama_penghargaan='$nama_penghargaan', uraian='$uraian', kompetensi='$kompetensi' where id='$id'";
          $sql = mysqli_query($connect, $query); 

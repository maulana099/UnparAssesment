...
$sql = "select * from datapengalamanpenelitian where id='$id'";
...
<div class="container-fluid" id="container-wrapper">
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Edit Data Pengalaman Penelitian</h1>
    <ol class="breadcrumb">
      <li class="breadcrumb-item"><a href="./">Home</a></li>
      <li class="breadcrumb-item">Formulir Asesment Mandiri</li>
      <li class="breadcrumb-item active" aria-current="page">Edit Data Pengalaman Penelitian</li>
    </ol>
  </div>
  ...
  <div class="row">
    <div class="col-lg-6">
      ...
      <div class="card mb-4">
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
          <h6 class="m-0 font-weight-bold text-primary">Edit Data Pengalaman Penelitian</h6>
        </div>
        <div class="card-body">
    ...
    if(isset($_POST['ubah_foto'])){
          ...
          if(move_uploaded_file($tmp, $path)){ 
              ...
              $query = "UPDATE datapengalamanpenelitian SET nokta='$nokta', nama_lengkap='$nama', periode='$periode', nama_tempat='$nama_tempat', jabatan='$jabatan', uraian='$uraian', kompetensi='$kompetensi', bukti_berkas='$bukti_berkas' where id='$id'";
              $sql = mysqli_query($connect, $query); 
    
               if($sql){
                  echo "<script>alert('Data Berhasil Diedit');document.location='index.php?page=datapengalamanpenelitian'</script>"; // Redirect ke halaman index.php // Redirect ke halaman index.php
                }else{
              ...
              $query = "UPDATE datapengalamanpenelitian SET nokta='$nokta', nama_lengkap='$nama', periode='$periode', nama_tempat='$nama_tempat', jabatan='$jabatan', uraian='$uraian', kompetensi='$kompetensi' where id='$id'";
              $sql = mysqli_query($connect, $query); 

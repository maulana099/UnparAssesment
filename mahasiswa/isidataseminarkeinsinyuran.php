...
<!--           <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
          ...
          <div class="card-body">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="nama_seminar">
            </div>
            <div class="form-group">
              <div class="">
      ...
      <div class="col-lg-6">
        ...
        <div class="card mb-4">
          <div class="card-body">
            ...
            <div class="form-group">
              <div class="">
                <span class="">Urain Materi</span>
              </div>
              <textarea type="text" name="uraian" class="form-control" id="exampleInputEmail1"></textarea>
            </div>
            <div class="form-group">
              <div class="">
              ...
              <div class="form-group">
            <input type="submit" class="btn btn-primary" name="tambahLoka" value="Simpan Data">
          </div>
        </div>
      </div>
    </form>
...
if (isset($_POST['tambahLoka'])) {
  ...
  $sql = mysqli_query($connect, "INSERT INTO seminar_keinsinyuran VALUES ('', '$nokta', '$nama_lengkap', '$bulan', '$nama_seminar', '$penyelenggara', '$lokasi', '$uraian', '$kompetensi','')");

  if($sql){
   echo "<script>alert('Data Berhasil Ditambah');document.location='index.php?page=dataseminarkeinsinyuran'</script>";
  }else{
    echo "Maaf terjadi kesalahan";
    echo "<a href='index.php?page=dataseminarkeinsinyuran'>Kembali</a>";
  }
}

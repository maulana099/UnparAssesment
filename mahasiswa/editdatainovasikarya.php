...
$sql = "SELECT * from inovasi_karya where id='$id'";
...
<div class="container-fluid" id="container-wrapper">
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Isi Data PUBLIKASI INOVASI KARYA</h1>
    <ol class="breadcrumb">
      <li class="breadcrumb-item"><a href="./">Home</a></li>
      <li class="breadcrumb-item">Formulir Asesment Mandiri</li>
      <li class="breadcrumb-item active" aria-current="page">PUBLIKASI INOVASI KARYA</li>
    </ol>
  </div>
  <p><b><span style="color: red;">Notes</span></b> : Karya Tulis di Bidang  Keinsinyuran yang Dipublikasikan.</p>
        ...
        <div class="card mb-4">
          <div class="card-body">
            ...
            <div class="form-group">
              ...
              <textarea type="text" name="materi" class="form-control" id="exampleInputEmail1"><?php echo $materi; ?></textarea> 
            </div>
            <div class="form-group">
              <div class="">
...
if (isset($_POST['updateInovasi'])) {
  ...
  if(isset($_POST['ubah_foto'])){
      ...
      if(move_uploaded_file($tmp, $path)){ 
          ...
          $query = "UPDATE inovasi_karya SET nokta='$nokta', nama_lengkap='$nama_lengkap', bulan='$bulan', judul='$judul', media='$media', lokasi='$lokasi', materi='$materi', kompetensi='$kompetensi', bukti_berkas='$bukti_berkas' where id='$id'";
          $sql = mysqli_query($connect, $query); 

           if($sql){
              echo "<script>alert('Data Berhasil Diedit');document.location='index.php?page=datainovasikarya'</script>"; // Redirect ke halaman index.php // Redirect ke halaman index.php
            }else{
          ...
          $query = "UPDATE inovasi_karya SET nokta='$nokta', nama_lengkap='$nama_lengkap', bulan='$bulan', judul='$judul', media='$media', lokasi='$lokasi', materi='$materi', kompetensi='$kompetensi' where id='$id'";
          $sql = mysqli_query($connect, $query); 

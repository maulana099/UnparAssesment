...
$sql = "SELECT * from manufaktur where id='$id'";
...
<!--           <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
          ...
          <div class="card-body">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="intansi" value="<?php echo $intansi; ?>">
            </div>
            <div class="form-group">
              <div class="">
                <span class="">Nama Proyek</span>
              </div>
              <input type="text" class="form-control" name="nama_proyek" value="<?php echo $nama_proyek; ?>">
            </div>
            <div class="form-group">
              <div class="">
        ...
        <div class="card mb-4">
          <div class="card-body">
            ...
            <div class="form-group">
              ...
              <input type="text" name="jabatan" class="form-control" id="exampleInputEmail1" value="<?php echo $jabatan; ?>">
            </div>
            <div class="form-group">
              <div class="">
            ...
            <input type="submit" class="btn btn-primary" name="updateManufaktur" value="UPDATE DATA">
          </div>
        </div>
      </div>
    </form>
...
<?php
if (isset($_POST['updateManufaktur'])) {
  $id = $data['id'];
  $nokta = $_POST['nokta'];
...
if(isset($_POST['ubah_foto'])){
      ...
      if(move_uploaded_file($tmp, $path)){ 
          ...
          $query = "UPDATE manufaktur SET nokta='$nokta', nama_lengkap='$nama_lengkap', perioda='$perioda', intansi='$intansi', nama_proyek='$nama_proyek', lokasi='$lokasi', jabatan='$jabatan', kegiatan='$kegiatan', kompetensi='$kompetensi', bukti_berkas='$bukti_berkas' where id='$id'";
          $sql = mysqli_query($connect, $query); 

           if($sql){
              echo "<script>alert('Data Berhasil Diedit');document.location='index.php?page=datapengalamanpekerjaan'</script>"; // Redirect ke halaman index.php // Redirect ke halaman index.php
            }else{
          ...
          $query = "UPDATE manufaktur SET nokta='$nokta', nama_lengkap='$nama_lengkap', perioda='$perioda', intansi='$intansi', nama_proyek='$nama_proyek', lokasi='$lokasi', jabatan='$jabatan', kegiatan='$kegiatan', kompetensi='$kompetensi' where id='$id'";
          $sql = mysqli_query($connect, $query); 

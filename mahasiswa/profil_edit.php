...
?>
                ...
                <div class="card-body">
                  <form action="" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                      ...
                      <input type="text" name="nokta" class="form-control" value="<?php echo $nokta; ?>" id="exampleInputEmail1" aria-describedby="emailHelp">
                    </div>
                    <div class="form-group">
    ...
    if(isset($_POST['ubah_foto'])){
      ...
      if(move_uploaded_file($tmp, $path)){ 
          ...
          $query = "UPDATE profil SET nokta='$nokta', nama_lengkap='$nama', jenis_kelamin='$jenkel', username='$username', password='$password', photo='$photo' where id='$id'";
          $sql = mysqli_query($connect, $query); 
          ...
          $query = "UPDATE profil SET nokta='$nokta', nama_lengkap='$nama', jenis_kelamin='$jenkel', username='$username', password='$password' where id='$id'";
          $sql = mysqli_query($connect, $query); 

...
<div class="container-fluid" id="container-wrapper">
  ...
  <p><b> Karya Tulis di Bidang  Keinsinyuran yang Dipublikasikan.</p></b>
...
<!--           <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
          ...
          <div class="card-body">
            ...
            <div class="form-group" id="simple-date1">
              ...
              <input type="text" name="bulan" class="form-control" required="" placeholder="">
              </div>
              <div class="form-group">
              <div class="">
        ...
        <div class="card mb-4">
          <div class="card-body">
            ...
            <div class="form-group">
              ...
              <textarea type="text" name="materi" class="form-control" id="exampleInputEmail1" required=""></textarea>
            </div>
            <div class="form-group">
              <div class="">
...
if (isset($_POST['tambahInovasi'])) {
  ...
  $sql = mysqli_query($connect, "INSERT INTO inovasi_karya VALUES ('', '$nokta', '$nama_lengkap', '$bulan', '$judul', '$media', '$lokasi', '$materi', '$kompetensi','')");

  if($sql){
   echo "<script>alert('Data Berhasil Ditambah');document.location='index.php?page=datainovasikarya'</script>";
  }else{
    echo "Maaf terjadi kesalahan";
    echo "<a href='index.php?page=datainovasikarya'>Kembali</a>";
  }
}

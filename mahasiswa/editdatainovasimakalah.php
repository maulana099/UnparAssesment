...
$sql = "SELECT * from inovasi_makalah where id='$id'";
...
$bulan = $data['bulan'];
$nama_lokakarya = $data['nama_lokakarya'];
...
<div class="container-fluid" id="container-wrapper">
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">MAKALAH LOKAKARYA KEINSINYURAN</h1>
    <ol class="breadcrumb">
  ...
  <p><b><span style="color: red;">Notes</span></b> : Makalah/Tulisan Yang Disajikan Dalam Seminar/Lokakarya Keinsinyuran.</p>
...
<!--           <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
          ...
          <div class="card-body">
            ...
            <div class="form-group">
              <div class="">
                <span class="">Nama Seminar / Lokakarya</span>
              </div>
              <input type="text" class="form-control" name="nama_lokakarya" value="<?php echo $nama_lokakarya; ?>">
            </div>
            <div class="form-group">
              <div class="">
      ...
      <div class="col-lg-6">
        ...
        <div class="card mb-4">
          <div class="card-body">
            ...
            <div class="form-group">
              <div class="">
                <span class="">Judul Makalah</span>
              </div>
              <textarea type="text" name="judul" class="form-control" id="exampleInputEmail1"><?php echo $judul; ?></textarea> 
            </div>
            <div class="form-group">
              <div class="">
                <span class="">Uraian Makalah</span>
              </div>
...
if (isset($_POST['updateInovasi'])) {
  ...
  if(isset($_POST['ubah_foto'])){
      ...
      if(move_uploaded_file($tmp, $path)){ 
          $query = "SELECT * FROM inovasi_karya WHERE id='".$id."'";
          $sql = mysqli_query($connect, $query);
          $data = mysqli_fetch_array($sql); 

          unlink("bukti_berkas/".$data['bukti_berkas']);
        
          $query = "UPDATE inovasi_makalah SET nokta='$nokta', nama_lengkap='$nama_lengkap', bulan='$bulan', nama_lokakarya='$nama_lokakarya', penyelenggara='$penyelenggara', lokasi='$lokasi', judul='$judul', uraian='$uraian', kompetensi='$kompetensi', bukti_berkas='$bukti_berkas' where id='$id'";
          $sql = mysqli_query($connect, $query); 

           if($sql){
              echo "<script>alert('Data Berhasil Diedit');document.location='index.php?page=datainovasimakalah'</script>"; // Redirect ke halaman index.php // Redirect ke halaman index.php
            }else{
          ...
          $query = "UPDATE inovasi_makalah SET nokta='$nokta', nama_lengkap='$nama_lengkap', bulan='$bulan', nama_lokakarya='$nama_lokakarya', penyelenggara='$penyelenggara', lokasi='$lokasi', judul='$judul', uraian='$uraian', kompetensi='$kompetensi' where id='$id'";
          $sql = mysqli_query($connect, $query); 

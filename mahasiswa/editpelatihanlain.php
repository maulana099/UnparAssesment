...
$sql = "select * from datapelatihanlain where id='$id'";
...
<div class="container-fluid" id="container-wrapper">
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Edit Data Pelatihan Manajemen dan Bidang Lainnya</h1>
    <ol class="breadcrumb">
      <li class="breadcrumb-item"><a href="./">Home</a></li>
      <li class="breadcrumb-item">Formulir Asesment Mandiri</li>
      <li class="breadcrumb-item active" aria-current="page">Edit Data Pelatihan Manajemen dan Bidang Lainnya</li>
    </ol>
  </div>
    ...
    <div class="col-lg-6">
      ...
      <div class="card mb-4">
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
          <h6 class="m-0 font-weight-bold text-primary">Edit Data Pelatihan Manajemen dan Bidang Lainnya</h6>
        </div>
        <div class="card-body">
...
if(isset($_POST['ubah_foto'])){
      ...
      if(move_uploaded_file($tmp, $path)){ 
          ...
          $query = "UPDATE datapelatihanlain SET nokta='$nokta', nama_lengkap='$nama', nama_pelatihan='$nama_pelatihan', tahun='$tahun', jumlah='$jumlah', uraian='$uraian', kompetensi='$kompetensi', bukti_berkas='$bukti_berkas' where id='$id'";
          $sql = mysqli_query($connect, $query); 

           if($sql){
              echo "<script>alert('Data Berhasil Diedit');document.location='index.php?page=datapelatihanlain'</script>"; // Redirect ke halaman index.php // Redirect ke halaman index.php
            }else{
          ...
          $query = "UPDATE datapelatihanlain SET nokta='$nokta', nama_lengkap='$nama', nama_pelatihan='$nama_pelatihan', tahun='$tahun', jumlah='$jumlah', uraian='$uraian',  kompetensi='$kompetensi' where id='$id'";
          $sql = mysqli_query($connect, $query); 

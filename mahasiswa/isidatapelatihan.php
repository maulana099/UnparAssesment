...
<div class="container-fluid" id="container-wrapper">
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Isi Data Pelatihan Teknik/Pertanian</h1>
    <ol class="breadcrumb">
      <li class="breadcrumb-item"><a href="./">Home</a></li>
      <li class="breadcrumb-item">Formulir Asesment Mandiri</li>
      <li class="breadcrumb-item active" aria-current="page">Isi Data Pelatihan Teknik/Pertanian</li>
    </ol>
  </div>
  <p><b>Pendidikan/Pelatihan Teknik/Pertanian  dan Profesi Keinsinyuran Yang Diikuti</b> </p>
  ...
  <form action="tambahdatapelatihan.php" method="post" enctype="multipart/form-data">
    <div class="row">
      <div class="col-lg-6">
        <!-- Form Basic -->
        <div class="card mb-4">
          <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
            <h6 class="m-0 font-weight-bold text-primary">Isi Data Pelatihan Teknik/Pertanian</h6>
          </div>
          <div class="card-body">
            ...
            <div class="form-group" id="simple-date1">
              ...
              <input type="text" name="nama_pelatihan" class="form-control" required="" placeholder="tidak ada">
              <br>
              <div class="input-group-prepend">
      ...
      <div class="col-lg-6">
        ...
        <div class="card mb-4">
          <div class="card-body">
            ...
            <div class="form-group">
              <div class="input-group-prepend">
                <span class="input-group-text">Kompetensi - <b> *KU,KK</b></span>
              </div>
